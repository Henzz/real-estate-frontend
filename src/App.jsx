  ...
  return (
    <Router>
      <Routes>
            ...
            <div className="">
              <div className="bg-[#dee8ff] sticky top-0 z-20">
                <div className="container mx-auto text-[#000000] flex items-center justify-between py-[8px] px-[50px]">
                  <div className="inline-flex h-[80px] rounded-full overflow-hidden align-middle">
                    <img
                      src={logo}
                      alt="logo"
                  ...
                  <div className="inline-block">
                    ...
                    <span
                      ...
                      className="py-2 px-5 text-lg inline-block opacity-90 hover:cursor-pointer hover:opacity-100 transition duration-200 ease-in-out border-b-2 border-b-orange-600"
                    >
                      About Us
                    </span>
                    <span
              ...
              <div className="container mx-auto">
                ...
                >
                  ...
                  <div className="mt-[45px] flex flex-wrap gap-6 justify-center">
                    ...
                    <button className="py-3 px-8 text-lg inline-block border border-[#696969] text-[#696969] rounded-full">
                      House
                    </button>
                    <button className="py-3 px-8 text-lg inline-block border border-[#696969] text-[#696969] rounded-full">
                      Office
        ...
        />
        {/* <Route path="/details" {...routeConfig} Component={Places} /> */}
